  ...
  return (
    <div className="childCardContainer">
      <div className="cardContentContainer">
        ...
        {childData.image == "" && childData.gender == "male"? (
            <img
              src={require("../assets/default-boy-image.png")}
              alt=""
              className="default-image"
            />
          ) : childData.image == "" && childData.gender == "female"? (
            <img
              src={require("../assets/default-girl-image.png")}
              alt=""
              className="default-image"
            />
          )
      ...
      <div className="parent-actionButtonsContainer">
        <div
          className="editIconContainer homeIcon"
          onClick={() => {
            navigate("/edit", { state: childData });
          }}
        ></div>
        <div
          className="historyIconContainer homeIcon"
          onClick={() => {
